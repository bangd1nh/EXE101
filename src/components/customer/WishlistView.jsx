...
const WishlistView = () => {
    ...
    const wishlist = [
        ...
        },
        {
            ...
            minHours: 3,
            images: [
                "/images/navbar/7c843a564a5e39502032cabcb0d4368b.jpg",
                "/images/navbar/f7a5a868ac09dd109f91c23c177cc354.jpg",
                "/images/navbar/dceecfa49cb847f2b03e97c31a5ba8f1.jpg",
        ...
        <div className="min-h-screen flex flex-col items-center bg-gray-100">
            <div className="w-full max-w-4xl bg-white mt-10 p-6 rounded-lg shadow-lg space-y-8">
                {wishlist.map((item) => (
                    <div
                        key={item.id}
                        className="p-6 border rounded-lg bg-gray-50 shadow-md hover:shadow-lg transition"
                    >
                        {/* Avatar + Tên + Địa điểm */}
                        ...
                        {expandedItem === item.id && (
                            <div className="mt-4 bg-gray-100 p-4 rounded-lg border">
                                ...
                                <p>
                                    <strong>⏳ Thời gian tối thiểu:</strong>{" "}
                                    {item.minHours} hours
                                </p>
