    ...
    const handleSave = async () => {
        try {
            ...
            if (roleUser === "CUSTOMER") {
                ...
                const userResult = await updateUserInfomation(
                    userId,
                    updatedUser
                );
                if (userResult.data.payload) {
                    const updatedData = userResult.data.payload;
                    setUser((prev) => ({
                        ...prev,
            ...
            if (roleUser === "PHOTOGRAPHER") {
                ...
                if (
                    userResult.data.payload ||
                    photographerResult.data.payload
                ) {
