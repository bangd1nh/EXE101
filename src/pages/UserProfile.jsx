  ...
  const handleSave = async () => {
    try {
      ...
      const updatedPhotographer = {
        ...
        desc: editedUser.Description, // Map Description to desc for API
      };
      ...
      if (userResult.data.payload || photographerResult.data.payload) {
        ...
        setUser((prev) => ({
          ...
          ...updatedUser,
          ...updatedPhotographer,
          Description: updatedPhotographer.desc, // Update local state
        }));
        setIsEditing(false);
      }
      fetchPhotographerData();
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              {isEditing ? (
                ...
                <p className="mt-1 text-gray-900 p-2">{user.FirstName}</p>
              )}
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-600">
              ...
              {isEditing ? (
                ...
                <p className="mt-1 text-gray-900 p-2">{user.LastName}</p>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="mt-1 text-gray-900 p-2">{user.PhoneNumber}</p>
              )}
            </div>
          </div>
        </div>
        <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-900">{formatDate(user.CreateAt)}</p>
            </div>
          </div>
        </div>
            ...
            {user.ExperienceYear ? (
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {isEditing ? (
                      <input
                        type="text"
                        name="ExperienceYear"
                        value={editedUser.ExperienceYear || ""}
                        onChange={handleChange}
                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2"
                      />
                    ) : (
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900 p-2">{user.Location}</p>
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-600">
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900 p-2">{user.Device}</p>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900 p-2">{user.Rating} / 5</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-600">
                    Price
