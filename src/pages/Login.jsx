...
import { MailOutlined, LockOutlined, EyeOutlined, EyeInvisibleOutlined, GoogleOutlined } from "@ant-design/icons";
  ...
  return (
    <div className="grid grid-cols-2 h-screen">
      ...
      <div className="px-50 py-20">
        ...
        <div className="mt-5">
          <Button variant="outlined" className="w-full" startIcon={<GoogleOutlined />}>
            Connect With Google
          </Button>
        </div>
        <div className="flex justify-center gap-2 mt-5">
          <p className="font-light">Dont have account? </p>
          <a className="text-blue-500 hover:cursor-pointer font-light" href="/register">
            Sign Up
          </a>
        </div>
      </div>
