...
import { FacebookOutlined, WhatsAppOutlined, TwitterOutlined } from "@ant-design/icons";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/contactForm/:photographerId" element={<ContactForm />} />
        <Route path="/photos" element={<Photo />} />
        <Route path="/login" element={<Login />} />
        <Route path="/register" element={<Register />} />
        <Route path="/photographer-profile/:photographerId" element={<PhotographerProfile />} />
